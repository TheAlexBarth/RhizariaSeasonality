...
: Generalized Additive Model results for integrated total Rhizaria abundance in different regions of the water column. edf = estimated degrees of freedom, F = F-statistic, p = p-value.
Models were selected using a backwards-stepwise approach with a retention threshold of p = 0.1 or a large enough reduction in model fit.
...
| $R^2_{adj}$=0.496                    | Avg F Flux             | 1.513 | 1.565 | 0.0037  |
...
: Taxa-specific generalized additive models for different regions of the water column.edf = estimated degrees of freedom, F = F-statistic, p = p-value.
Models were selected using a backwards-stepwise approach with a retention threshold of p = 0.1 or a large enough reduction in model fit.
